...
const ACTIONS = [
  ...
  { key: 'service.log', label: 'Service log entries' },
  { key: 'station.create', label: 'Stations added' },
  { key: 'station.update', label: 'Station edits' },
  { key: 'station.delete', label: 'Stations deleted' },
  { key: 'document.upload', label: 'Documents uploaded' },
  { key: 'document.delete', label: 'Documents removed' },
  { key: 'data.snapshot', label: 'Backups created' },
